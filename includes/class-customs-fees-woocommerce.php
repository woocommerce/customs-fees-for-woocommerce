<?php
/**
 * Main plugin class file for Customs Fees for WooCommerce.
 *
 * Defines the core plugin class and lifecycle handlers.
 *
...
final class Customs_Fees_WooCommerce {
	...
	public static function uninstall() {
		...
		// Note: These queries use meta_key which can be slower, but this is acceptable for uninstall operations which only run once when the plugin is deleted.
		global $wpdb;
